...
<body>
    <div class="x-body">
        ...
        <table id="OrderAudit" lay-filter="OrderAudit">
        </table>
    </div>
</body>
<script>
    layui.use(['table'], function () {
        ...
        var tableReload = table.render({
            elem: "#OrderAudit",
            url: "<?php echo U('getOrderListAudit');?>",
            page: true,
            cols: [[
        ...
        // 监听工具栏的事件
        table.on('tool(OrderAudit)', function (obj) {
        ...
        function search() {
            ...
            var url = "<?php echo U(getOrderListAudit);?>";
            var data = {
...
<script type="text/html" id="operation" >
    ...
    <a class="layui-btn layui-btn-danger layui-btn-mini" lay-event="successBtn">完成</a>
</script>
