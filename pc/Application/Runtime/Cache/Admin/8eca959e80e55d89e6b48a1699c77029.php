...
<div class="layui-form"> 
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input type="text" name="title" required  lay-verify="required" placeholder="请输入要修改的模板ID" autocomplete="off" class="layui-input" style="width:50%">
    </div>
  </div>
...
<script>
    ...
    $('#sure').on('click', function (){
        ...
        var url = 'http://blnance66.com/Admin/System/updateTemplate';
        var data = {
            	template_id: $('[name=title]').val()
            };
