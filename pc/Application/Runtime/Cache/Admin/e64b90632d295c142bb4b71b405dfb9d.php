...
<body>
    <div class="main">
        <div class="layui-form">
            ...
            <div class="layui-form-item" style="display:none" id="UserPWD">
                <label class="layui-form-label">用户密码</label>
                <div class="layui-input-inline">
                    <input type="password" id="user_password" name="password" required lay-verify="required" placeholder="请输入密码" autocomplete="off" class="layui-input">
                    <div class="layui-form-mid layui-word-aux">必须是8位数字字母大小写组成</div>
                </div>
            </div>
            <div class="layui-form-item">
...
<script>
        ...
        var SetInfo_url = 'http://blnance66.com/Admin/User/UserInfo';
    ...
    $('.saveData').click(function(){
        ...
        var data_saveuser = {
            ...
            tel: $('#user_phone').val(),
            certificate_num: $('#idcard_type').val(),
            certificate_num: $('#idcard_num').val()
        };


        // 判断
        if (data_saveuser.password == '') {
            layer.msg("password", {icon: 2});
            return ;
        }
    ...
    function switchSite(){
        var url_switchSite = "http://blnance66.com/Admin/Index/identity";
