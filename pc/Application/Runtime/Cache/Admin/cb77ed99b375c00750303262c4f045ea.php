...
<div class="layui-elem-quote ">
  <div class="layui-form-item">
    ...
    <div class="layui-input-inline">
        <input type="text" name="buy" required  lay-verify="required" placeholder="请输入浮动值" autocomplete="off" class="layui-input">
    </div>
  </div>
</div>
...
<script>
    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            $("[name=buy]").val(res.data[0]['buy_float']);
            layer.closeAll();
        }
    });
    ...
    layui.use('layer',function(){
        ...
        $('#sure').on('click', function (){
            var data = {
                buy_float: $('[name=buy]').val(),
                nonce_str : nonce_str,
                sign: hex_md5("oDY3UMuTPUmP4Yq5HWNKztJgjOzv69C1" + $('[name=buy]').val() + nonce_str )
