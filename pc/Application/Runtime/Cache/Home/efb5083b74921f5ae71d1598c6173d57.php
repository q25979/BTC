...
<script type="text/javascript">
    ...
    <div class="content-messagetip col-lg-8 col-md-8 col-sm-8 col-xs-12">
        <div style="margin-top: 20px;"><a href="http://blnance66.com/Home/MessageTip/index"> < <?php echo (L("_HINT_BACK_TO_MSG_")); ?></a></div>
        <br>
...
//        获取information_id
        ...
        var url_newsContent = 'http://blnance66.com/Home/MessageTip/newsContent';
