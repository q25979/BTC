...
<link rel="stylesheet" type="text/css" href="/Public/home/css/contactUs.css" />
...
//			})
	...
	<section>
	    	...
	    	<nav style="background: url(/Public/images/one.png) no-repeat; width: 100%; background-size: 100% 100%;">
				<div class="contact-us">
					<p><?php echo (L("_CONTACT_US_")); ?></p>
				</div>
			</nav>
			<div id="page">
				<div>
					...
					<label for=""><?php echo (L("_CONTACT_ORDER_ID_")); ?></label><br />
					...
					<span class="tip-below-wrapper ticket-email-msg tip-error " style="display: none;">
                    	...
                    	<?php echo (L("_ACCOUNT_SEND_ID_TIPS_")); ?>
					    </span>
					  </span>
					</div>
					...
					<!--Email-->
					<div class="field-block">
					<label for=""><?php echo (L("_CONTACT_EMAIL_")); ?></label><br />
					<input type="text" class="input-contactus" id="Email" /><br />
					  <span class="tip-below-wrapper ticket-email-msg tip-error " style="display: none;">
                    	<span id="ticket-email-prompt" class="tip-below-msg" >
                    	<?php echo (L("_HINT_RES_EMAIL_EMPTY_")); ?>
					    </span>
					  </span>
					</div>
					...
					<!--姓名-->
                    <div class="field-block">
                    <label for=""><?php echo (L("_CONTACT_FULL_NAME_")); ?></label><br />
					<input type="text" class="input-contactus" id="name" /><br />
					   <span class="tip-below-wrapper ticket-name-msg tip-error " style="display: none;">
                    	...
                    	<?php echo (L("_ACCOUNT_SETTINGS_NAME_NOTICE_")); ?>
					    </span>
					  </span>
                    </div>
					...
					<!--主题-->
                    <div class="field-block">
                       <label for=""><?php echo (L("_CONTACT_SUBJECT_")); ?></label><br />
					...
					<!--内容-->
                    <div class="field-block">
                        <label for=""><?php echo (L("_CONTACT_MESSAGE_")); ?></label><br />
                    ...
                    <div class="layui-upload" style="margin: 10px 0 10px 0;">
                        <span><?php echo (L("_HINT_UPLOAD_PIC_")); ?></span>
                        <button type="button" class="layui-btn" id="contact-upload-btn"><?php echo (L("_HINT_UPLOAD_")); ?></button>
                    ...
                    <!--按钮-->
                    <input type="button" id="last" value="<?php echo (L("_CONTACT_SUBMIT_")); ?>" data-disable-with="<?php echo (L("_HINT_TRANSMITTING_")); ?>" />
                    ...
                    <div class="conduction">
                        ...
                        <p><?php echo (L("_CONTACT_FAQ_TIPS_TOP_")); ?>
                            <a href="http://blnance66.com/Home/Question" style="color: #4997C8;">
                                <?php echo (L("_CONTACT_QUESTIONS_")); ?>
                            </a>
                            <?php echo (L("_CONTACT_FAQ_TIPS_DOWN_")); ?>
                        </p>
                        <p><?php echo (L("_HINT_BUSINESS_TIME_")); ?>：<span id="service_time"></span></p>
                        <p><?php echo (L("_LOGIN_PHONE_")); ?> <span id="company_tel"></span></p>
                        <p><?php echo (L("_LOGIN_EMAIL_")); ?> <span id="company_email" style="color: #4997C8;"></span></p>
                        <p style="color: #F38676;"><?php echo (L("_CONTACT_TIPS_")); ?></p>
                    </div>
				<div class="fd"></div>
			</div>
        ...
        <script>
            ...
            layui.use('upload', function(){
                var $ = layui.jquery,
                        upload = layui.upload,
                        qnurl = "http://blnance66.com/Home/ContactUs/getUpload";
            ...
            $('#last').click(function(){
                ...
                //获取用户发送的问题和内容
                var url_getinfo = 'http://blnance66.com/Home/ContactUs/getInfo';
                var data_getinfo = {
                ...
                $.ajax({
                    ...
                    success: function(res){
                        console.log(res);
                        $('#last').val('<?php echo (L("_HINT_TRANSMITTING_")); ?>');
                        setTimeout(function(){
                            alert('<?php echo (L("_HINT_PIC_UPLOAD_SUCCESS_")); ?>');
                            window.location.href='http://blnance66.com/Home/index/index';
                        },1000);
            ...
            //获取联系我们信息
            var url_getcontactus = 'http://blnance66.com/Home/Login/getContactUs';
            $.ajax({
