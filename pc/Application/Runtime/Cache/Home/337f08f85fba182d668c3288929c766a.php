...
<script type="text/javascript">
	...
	<div class="content-enable col-lg-8 col-md-8 col-sm-8 col-xs-12">
		<div class="enable">
			<div class="get-back">
				<a href="http://blnance66.com/Home/Security/index"> &lt; <?php echo (L("_HINT_SECURITY_SETTING_")); ?></a>
			</div>
			<h3><?php echo (L("_HINT_SECURITY_QUESTIONS_")); ?></h3>

			<div class="secure-question-notice">
				<p class="highlight"><?php echo (L("_ACCOUNT_SETTINGS_CLAUSE_")); ?></p>
				<ul>
					<li><?php echo (L("_HINT_SET_QUESTION_")); ?></li>
					<li><?php echo (L("_HINT_NOT_CHANGE_QUESTION_")); ?></li>
				</ul>
			</div>
				...
				<div class="form-horizontal">
					<div class="form-group secure-question">
						...
						<div class="col-sm-10 col-xs-10 col-lg-10">
							<input type="text" maxlength="30" class="form-control " id="secure-q1" placeholder="<?php echo (L("_HINT_CHOOSE_QUESTION_")); ?>">
							<input type="text" maxlength="30" id="answer-q1" class="answer-ques" placeholder="<?php echo (L("_HINT_SET_YOUR_ANSWER_")); ?>" name="system[answers][0]">
						</div>
					...
					<div class="form-group secure-question">
						...
						<div class="col-sm-10 col-xs-10">
							<input type="text" maxlength="30" class="form-control " id="secure-q2" placeholder="<?php echo (L("_HINT_CHOOSE_QUESTION_")); ?>">
							<input type="text" maxlength="30" id="answer-q2" class="answer-ques" placeholder="<?php echo (L("_HINT_SET_YOUR_ANSWER_")); ?>" name="system[answers][1]">
						</div>
					...
					<div class="form-group secure-question">
						...
						<div class="col-sm-10 col-xs-10">
							<input type="text" maxlength="30" class="form-control " id="secure-q3" placeholder="<?php echo (L("_HINT_CHOOSE_QUESTION_")); ?>">
							<input type="text" maxlength="30" id="answer-q3" class="answer-ques" placeholder="<?php echo (L("_HINT_SET_YOUR_ANSWER_")); ?>" name="system[answers][2]">
						</div>
				
					</div>
					  <span id="waring-span" class="enable-below-msg"  >
					      <?php echo (L("_HINT_SET_THREE_QUESTION_")); ?>
					  </span>
					<div class="secure-btns form-group">
						<label  class="col-sm-1 col-xs-1 control-label"></label>
						<div class="col-sm-10 col-xs-10">
							<input name="commit" disabled="disabled" value="<?php echo (L("_CONTACT_SUBMIT_")); ?>" id="secure-answer" class="btn  btn-primary btn-enable" type="submit">
						</div>
					</div>
			    </div>
			</div>
  ...
  <script>
	...
	var layer = layui.layer;
		...
		$('#secure-answer').on('click', function () {
			...
			var u = 'http://blnance66.com/Home/Security/Securityenable';
			var	d = {
			...
			$.ajax({
				...
				success: function (res) {
					...
					if(parseInt(res.code) == 0) {
                        ...
                        //跳转
                        window.location.replace("http://blnance66.com/Home/Security/index");
                    })
                }else{
