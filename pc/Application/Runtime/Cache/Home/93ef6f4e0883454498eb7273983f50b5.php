...
<section>
    ...
    <div class="ques-header">
        <div class="ques-header-img" style="background: url(/Public/images/one.png) no-repeat;">
            <div class="ques-header-font"><?php echo (L("_FAQ_")); ?></div>
        </div>
        ...
        <div class="ques-body">
            <div class="ques-body-left">
                <div class="ques-body-item">
                    <div><a href="#"><?php echo (L("_FAQ_SEND_RECEIVE_")); ?></a></div>
                    <ul>
                ...
                <div class="ques-body-item">
                    <div><a href="#"><?php echo (L("_FAQ_BUY_SELL_")); ?></a></div>
                    <ul>
    ...
    <script type="text/javascript">
    	...
    	var FAQ = new Vue({
            ...
            methods: {
                getData: function () {
                    var vm = this;
                    var url = 'http://localhost:8081/Home/Question/getCommonProblemAll';
                ...
                getContent : function(id){
                    var u = 'http://localhost:8081/Home/Question/FAQ.html?common_problem_id=' + id;;
                    sg.jump(u);
                },
                getMore : function(type){
                    var u = 'http://localhost:8081/Home/Question/More.html?type=' + type;
                    sg.jump(u); 
                }
            }
        });
