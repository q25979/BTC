...
<link rel="stylesheet" type="text/css" href="/Public/home/css/ViewMore.css" />
<body>
<!-- 顶部 -->
...
<!--查看更多-->
<div id="probelmMore">
    <div class="ViewMore-head" style="background-image: url(/Public/images/one.png);">
    	<!--文字-->
    ...
    <div style="width: 100%;display: flex;justify-content: center;align-items: center;">
        <section class="col-lg-12 col-md-12 col-sm-12 col-xs-12 total-container" style="max-width: 1200px;padding: 0; margin: 0 auto; margin-top: 0px;position: relative;overflow: hidden;" >
                ...
                <div class="ViewMore-container">
                    <div class="back">
                        <a href="http://blnance66.com/Home/Question">&lt;&lt;&lt; <?php echo (L("_LOGIN_FAQ_")); ?></a>
                    </div>
        ...
        methods: {
            getData: function () {   
                ...
                if (vm.GetRequest().type != null && vm.GetRequest().type != "") {
                    ...
                    var url = 'http://blnance66.com/Home/Question/getFAQ';
                    if (vm.type == 1) {
                        vm.typeTitle = "<?php echo (L("_FAQ_SEND_RECEIVE_")); ?>";
                    }else if (vm.type == 2) {
                        vm.typeTitle = "<?php echo (L("_FAQ_BUY_SELL_")); ?>";
                    }else if (vm.type == 3) {
                        vm.typeTitle = "<?php echo (L("_FAQ_ACCEPT_PAYMENTS_")); ?>";
                    }else if (vm.type == 4) {
                        vm.typeTitle = "<?php echo (L("_FAQ_ABOUT_")); ?>";
                    }else if (vm.type == 5) {
                        vm.typeTitle = "<?php echo (L("_FAQ_SECUROTY_ID_VER_")); ?>";
                    }else if (vm.type == 6) {
                        vm.typeTitle = "<?php echo (L("_FAQ_ANTI_FRAUD_TREAT_")); ?>";
                    }
                }
            ...
            getcontent : function(id){
                var u = 'http://blnance66.com/Home/Question/FAQ.html?common_problem_id=' + id;;
                sg.jump(u);
            }
        }
