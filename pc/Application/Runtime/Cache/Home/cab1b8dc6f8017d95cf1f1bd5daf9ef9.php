	...
	<div class="content-update col-lg-8 col-md-8 col-sm-8 col-xs-12">
		<div class="update">
			...
			<div class="Password-changes">
				<h3><?php echo (L("_ACCOUNT_SECURITY_CHANGE_PWD_")); ?></h3>
				<br />
				...
				<div class="password-box">
					<div class="new-password">
						...
						<div class="form-group">
							<label class="used-label" for="InputPassword1"><?php echo (L("_HINT_OLD_PWD_")); ?>:</label>
					...
					<div class="set-password">
						<div class="form-group">
							<label class="set-label" for="InputPassword1"><?php echo (L("_HINT_NEW_PWD_")); ?>:</label>
					...
					<div class="affirm-password">
						<div class="form-group">
							<label class="affirm-label" for="InputPassword1"><?php echo (L("_HINT_NEW_PWD_CONFIRM_")); ?>:</label>
							...
							<span class="pas-below-wrapper ticket-affirm-msg pas-error " style="display: none;">
		                    	...
		                    	<?php echo (L("_HINT_PWD_TWICE_DIFFERENT_")); ?>
							    </span>
					        </span>
						</div>
					...
					<div class="passwoed-btns">
						<input id="updatebtn" name="commit" value="<?php echo (L("_HINT_PWD_RESET_")); ?>" data-disable-with="傳送中…" class="btn  btn-primary btn-one" type="submit" disabled="disabled" >
...
layui.use('layer', function(){
	...
	$(document).ready(function() {
		...
		$('#current-password').blur(function(){
			...
			var url = "http://blnance66.com/Home/Security/getpass";
			...
			$.ajax({
				...
				data:{
					password:current,
					nonce_str:nonce_str,
					sign: hex_md5('oDY3UMuTPUmP4Yq5HWNKztJgjOzv69C1'+ nonce_str + current)
				},
				success: function (res) {
		            if(	!res.code == 0 ){
		...
		$('#updatebtn').on('click', function () {
			...
			var u = 'http://blnance66.com/Home/Security/Passwordupdate',
				d = {
					newpassword: newpassword,
					nonce_str: nonce_str,
					sign: hex_md5('oDY3UMuTPUmP4Yq5HWNKztJgjOzv69C1' + newpassword + nonce_str)
				};
