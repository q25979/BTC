...
<script type="text/javascript">
	...
	<script type="text/javascript">
		...
		function getAmount (id){
			var url_Amount = "http://blnance66.com/Home/DealDetails/total";
			var data_Amount = {
				currency_type: id
			};
		...
		function getDealDetails(id,tdHint,tbodySelector,page) {
			var url_DealDetails = "http://blnance66.com/Home/DealDetails/getDealInfo";
				...
				success:function(res){
					...
					if(res.code == 0){
						...
						$('.deal-tr').click(function() {
							...
							var u  = 'http://blnance66.com/Home/DealDetails/details?order_id=' + id;
