...
<script type="text/javascript">
	...
	<script type="text/javascript">
		...
		function getAmount (id){
			var url_Amount = "http://192.168.0.128:8081/Home/DealDetails/total";
			var data_Amount = {
				currency_type: id
			};
		...
		function getDealDetails(id,tdHint,tbodySelector,page) {
			var url_DealDetails = "http://192.168.0.128:8081/Home/DealDetails/getDealInfo";
				...
				success:function(res){
					...
					if(res.code == 0){
						...
						$('.deal-tr').click(function() {
							...
							var u  = 'http://192.168.0.128:8081/Home/DealDetails/details?order_id=' + id;
