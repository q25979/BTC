...
<script type="text/javascript">
	...
	<div class="content-Deal col-lg-8 col-md-8 col-sm-8 col-xs-12">
		...
		<div class="buy-tab">
			<!--选项卡1-->
			<div class="tab1">
				<a href="http://localhost:8081/Home/WithdrawalDetail/index" class="buy-BTC"><?php echo (L("_WITHDRAW_CASH_RECORD_")); ?></a>
			</div>
	...
	<script type="text/javascript">
		...
		function getWithdrawalDetail(page) {
			var url_WithdrawalDetail = "http://localhost:8081/Home/WithdrawalDetail/lookUpOrder";
