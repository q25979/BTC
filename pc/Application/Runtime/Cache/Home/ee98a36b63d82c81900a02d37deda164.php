...
<script type="text/javascript">
	...
	<link rel="stylesheet" type="text/css" href="/Public/home/css/WithdrawalDetail.min.css" />
	<div class="content-Deal col-lg-8 col-md-8 col-sm-8 col-xs-12">
		...
		<div class="buy-tab">
			<!--选项卡1-->
			<div class="tab1">
				<a href="http://192.168.0.128:8081/Home/WithdrawalDetail/index" class="buy-BTC"><?php echo (L("_WITHDRAW_CASH_RECORD_")); ?></a>
			</div>
		...
		<div class="deal-btc">
			<div class="table-box">
				<table class="table table-hover transactions-table" id="WithdrawalDetail">
					<thead>
						<tr>
							<th><?php echo (L("_WITHDRAW_CASH_ID_")); ?></th>
							<th><?php echo (L("_WITHDRAW_CASH_CASH_NUM_")); ?></th>
							<th><?php echo (L("_WITHDRAW_CASH_STATUS_")); ?></th>
							<th><?php echo (L("_WITHDRAW_CASH_DATE_")); ?></th>
						</tr>
					</thead>
	...
	<script type="text/javascript">
		...
		function getWithdrawalDetail(page) {
			var url_WithdrawalDetail = "http://192.168.0.128:8081/Home/WithdrawalDetail/lookUpOrder";
					...
					if(res.code == 0){
						...
						for( i = 0; i < res.data.length; i++){
							...
							if(res.data[i].status == 0){
								status = "<?php echo (L("_HINT_TO_AUDIT_")); ?>";
								}else if(res.data[i].status == 1){
									status = "<?php echo (L("_HINT_PASS_THE_AUDIT_")); ?>";
								}else if(res.data[i].status == -1){
									status = "<?php echo (L("_HINT_AUDIT_FAILED_")); ?>";
							}
