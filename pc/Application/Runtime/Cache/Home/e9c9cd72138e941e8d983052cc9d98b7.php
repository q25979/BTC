        ...
        var addressVm = new Vue({
            ...
            methods: {
                getBtcAddress : function(){
                    var vm = this;
                    var url = "http://192.168.0.128:8081/Home/WalletAddr/get";
                    $.get(url,function(res){
                ...
                addAddress : function(){
                    var vm = this;
                    var url = "http://192.168.0.128:8081/Home/WalletAddr/addNew";
                ...
                addressDetail : function(index){
                    var vm = this;
                window.location.href="http://192.168.0.128:8081/Home/WalletAddr/receiveDetail.html?user_wallet_address_id="+vm.addressList[index].user_wallet_address_id;
                },
