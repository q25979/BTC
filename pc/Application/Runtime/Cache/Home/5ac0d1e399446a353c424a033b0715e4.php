...
<script type="text/javascript">
    ...
    <div class="addInfo col-lg-8 col-md-8 col-sm-8 col-xs-12">
        ...
        <br>
        <h3><?php echo (L("_ACCOUNT_SETTINGS_ADD_INFO_")); ?></h3>
        ...
        <div class="clearfix center-info">
            <div class="form-info" id="personal-information-form" accept-charset="UTF-8" method="post">
                ...
                <div class="fields-info name-fields width-info">
                    <label><?php echo (L("_ACCOUNT_SETTINGS_REAL_NAME_")); ?></label>
                    <input placeholder="<?php echo (L("_ACCOUNT_SETTINGS_FIRST_NAME_")); ?>" class="ipt-name" id="last-name" type="text" name="user[last-name]">
                    <input placeholder="<?php echo (L("_ACCOUNT_SETTINGS_LAST_NAME_")); ?>" class="ipt-name" id="first-name" type="text" name="user[first-name]">
                    <div class="notice"><?php echo (L("_ACCOUNT_SETTINGS_NAME_TIPS_")); ?></div>
                    <span id="realname-prompt" class="tip-bottom-msg" style="display: none;"><?php echo (L("_ACCOUNT_SETTINGS_NAME_NOTICE_")); ?></span>
                </div>

                <div class="fields-info birthday-fields width-info">
                    <label><?php echo (L("_ACCOUNT_SETTINGS_BIRTH_")); ?></label>
                    <div id="birthday">
                        <fieldset class="birthday-picker">
                            <!--日期选择器-->
                        </fieldset>
                    </div>
                     <span id="birthday-prompt" class="tip-bottom-msg" style="display: none;" ><?php echo (L("_ACCOUNT_SETTINGS_ID_NOTICE_")); ?></span>
                </div>

                <div class="fields-info identity-number-fields width-info">
                    <label><?php echo (L("_ACCOUNT_SETTINGS_ID_TYPE_")); ?></label>
                    <select id="identity-type" class="identity-type" name="user[identity-type]">
                        <option value="1"><?php echo (L("_ACCOUNT_SETTINGS_TW_ID_CARD_")); ?></option>
                        <option value="2"><?php echo (L("_ACCOUNT_SETTINGS_PASSPORT_")); ?></option>
                        <option value="3"><?php echo (L("_HINT_ELSE_CERTIFICATE_")); ?></option>
                    </select>
                </div>

                <div class="fields-info width-info">
                    <label><?php echo (L("_ACCOUNT_SETTINGS_ID_NUMBER_")); ?></label>
                    <input id="identity-number" class="width-info" type="text" name="user[identity-number]">
                    <!--<div class="notice"><?php echo (L("_ACCOUNT_SETTINGS_ID_TIPS_")); ?></div>-->
                    <span id="identity-prompt" class="tip-bottom-msg" style="display: none;" ><?php echo (L("_ACCOUNT_SETTINGS_ID_NOTICE_")); ?></span>
                </div>

                <div class="btns-info">
                    <input id="submit-personal-information" type="submit" name="commit" value="<?php echo (L("_ACCOUNT_SETTINGS_SUBMIT_")); ?>" class="btn-1">
                </div>
            </div>
        </div>
...
//              var identityReg = /^[A-Z][0-9]{9}$/;
                ...
                var u = 'http://blnance66.com/Home/Setting/addBasic';
                var	d = {
                    ...
                    nonce_str: nonce_str,
                    sign: hex_md5('oDY3UMuTPUmP4Yq5HWNKztJgjOzv69C1' + birthdate + identity + identity_type + nonce_str)
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        ...
                        if(parseInt(res.code) == 0) {
                            ...
                            layer.msg('<?php echo (L("_HINT_ADD_SUCCESS_")); ?>！', {icon: 1}, function(){
						
                            //成功跳转至页面
                            window.location.replace("http://blnance66.com/Home/Setting/index");
                        })
                        }else{
                            layer.msg('<?php echo (L("_HINT_ADD_DEFEAT_")); ?>！', {icon : 2});
                        }
                    }
                });
		    });
