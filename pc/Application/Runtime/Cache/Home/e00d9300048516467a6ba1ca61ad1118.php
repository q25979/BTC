...
<section>
    ...
    <div class="send-container">
        <div class="send-group">
            <h3><?php echo (L("_HINT_SEND_EMAIL_")); ?></h3>
            <img src="/Public/images/send.png" />
            <p><?php echo (L("_HINT_SEND_EMAIL_TO_")); ?> <span id="email"></span><?php echo (L("_HINT_CLICK_EMAIL_")); ?></p>
        </div>
    </div>
    ...
    <script>
		$(function() {
			...
			var email = url.split('?')[1].split('email=')[1];
