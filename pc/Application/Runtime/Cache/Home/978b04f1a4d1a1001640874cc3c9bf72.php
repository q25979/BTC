...
<link rel="stylesheet" type="text/css" href="/Public/home/css/FAQ.css" />
<body>
<!-- 顶部 -->
...
<!--常见问题-->
<div class="FAQ-head" style="background-image: url(/Public/images/banner1.jpg);">
</div>
    ...
    <section class="col-lg-12 col-md-12 col-sm-12 col-xs-12 total-container" style="max-width: 1200px;padding: 0; margin: 0 auto; margin-top: 0px;position: relative;overflow: hidden;" >
            ...
            <div class="FQA-container" id="content">
				<div class="faq_category">
					<div class="back">
						<a href="http://localhost:8081/Home/Question">&lt;&lt;&lt; <?php echo (L("_LOGIN_FAQ_")); ?></a>
					</div>
    ...
    var vm = new Vue({
        ...
        methods: {
            ...
            getData: function () {
                ...
                var u  = 'http://localhost:8081/Home/Question/details';
