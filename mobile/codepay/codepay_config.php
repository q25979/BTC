 ...
 */
$codepay_config['return_url'] = $codepay_config['host'] . '/index/pay/codepay_notify.html'; //自动生成跳转地址
...
$codepay_config['notify_url'] = $codepay_config['host'] . '/index/pay/codepay_notify.html'; //自动生成通知地址 优先级最高不传入则为系统设置里设置
//异步通知地址
 ...
 */
 $db=include("../application/database.php"); //导入配置文件
define('DB_HOST', $db['hostname']); //数据库服务器地址
define('DB_USER',  $db['username']);  //数据库用户名
define('DB_PWD',  $db['password']);//数据库密码
define('DB_NAME',  $db['database']);  //数据库名称
define('DB_PORT',  $db['hostport']);  //数据库端口
